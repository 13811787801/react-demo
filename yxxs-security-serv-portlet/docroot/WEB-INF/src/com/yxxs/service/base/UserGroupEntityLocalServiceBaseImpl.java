...
import com.yxxs.service.UserGroupEntityLocalService;
...
/**
 * The base implementation of the user group entity local service.
 * 
 * <p>
 ...
 * {@link com.yxxs.service.impl.UserGroupEntityLocalServiceImpl}.
 * </p>
 * 
 * @author Administrator
 * @see com.yxxs.service.impl.UserGroupEntityLocalServiceImpl
 * @see com.yxxs.service.UserGroupEntityLocalServiceUtil
 * @generated
 */
public abstract class UserGroupEntityLocalServiceBaseImpl implements UserGroupEntityLocalService {
  /*
   * NOTE FOR DEVELOPERS:
   * 
  ...
  /**
   * Adds the user group entity to the database. Also notifies the appropriate model listeners.
   * 
   * @param userGroupEntity the user group entity
   * @return the user group entity that was added
   * @throws SystemException if a system exception occurred
   */
  public UserGroupEntity addUserGroupEntity(UserGroupEntity userGroupEntity) throws SystemException {
    userGroupEntity.setNew(true);

    userGroupEntity = userGroupEntityPersistence.update(userGroupEntity);
   ...
   */
  public UserGroupEntity createUserGroupEntity(long id) {
    return userGroupEntityPersistence.create(id);
  }

  /**
   * Deletes the user group entity with the primary key from the database. Also notifies the
   * appropriate model listeners.
   * 
   * @param id the primary key of the user group entity
   * @throws PortalException if a user group entity with the primary key could not be found
   * @throws SystemException if a system exception occurred
   */
  public void deleteUserGroupEntity(long id) throws PortalException, SystemException {
    UserGroupEntity userGroupEntity = userGroupEntityPersistence.remove(id);
  }

  /**
   * Deletes the user group entity from the database. Also notifies the appropriate model listeners.
   * 
   * @param userGroupEntity the user group entity
   * @throws SystemException if a system exception occurred
   */
  public void deleteUserGroupEntity(UserGroupEntity userGroupEntity) throws SystemException {
    userGroupEntityPersistence.remove(userGroupEntity);
  }

  public UserGroupEntity fetchUserGroupEntity(long id) throws SystemException {
    return userGroupEntityPersistence.fetchByPrimaryKey(id);
  }

  /**
   * Returns the user group entity with the primary key.
   * 
   * @param id the primary key of the user group entity
   ...
   * @throws SystemException if a system exception occurred
   */
  public UserGroupEntity getUserGroupEntity(long id) throws PortalException, SystemException {
    return userGroupEntityPersistence.findByPrimaryKey(id);
  }

  /**
   * Returns a range of all the user group entities.
   * 
   * <p>
   ...
   * @return the range of user group entities
   * @throws SystemException if a system exception occurred
   */
  public List<UserGroupEntity> getUserGroupEntities(int start, int end) throws SystemException {
    return userGroupEntityPersistence.findAll(start, end);
  }

  /**
   * Returns the number of user group entities.
   * 
   * @return the number of user group entities
   * @throws SystemException if a system exception occurred
   */
  public int getUserGroupEntitiesCount() throws SystemException {
    return userGroupEntityPersistence.countAll();
  }

  /**
   * Updates the user group entity in the database or adds it if it does not yet exist. Also
   * notifies the appropriate model listeners.
   * 
   * @param userGroupEntity the user group entity
   * @param merge whether to merge the user group entity with the current session. See
   ...
   *        for an explanation.
   * @return the user group entity that was updated
   * @throws SystemException if a system exception occurred
   */
  public UserGroupEntity updateUserGroupEntity(UserGroupEntity userGroupEntity)
  ...
  private static Log _log = LogFactoryUtil.getLog(UserGroupEntityLocalServiceBaseImpl.class);
}
